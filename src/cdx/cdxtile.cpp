//////////////////////////////////////////////////////////////////////////////////
// $Source: /cvsroot/cdx/cdx3.0/src/cdx/cdxtile.cpp,v $
// $Author: istan $
//
// $Log: cdxtile.cpp,v $
...
//////////////////////////////////////////////////////////////////////////////////
#ifdef SAVE_RCSID
    static char rcsid[] = "@(#) $Id: cdxtile.cpp,v 1.9 2000/09/09 08:39:09 istan Exp $";
#endif
...
void CDXTile::Draw(int x, int y, CDXSurface *s, int BlitType, int tile)
{
    ...
    switch (BlitType) {
    case CDXBLT_BLK:
        CDXSurface::DrawBlk(s, x, y, &m_BlockRects[tile]);
        break;
    ...
    case CDXBLT_TRANS:
        CDXSurface::DrawTrans(s, x, y, &m_BlockRects[tile]);
        break;
