//////////////////////////////////////////////////////////////////////////////////
// $Source: /cvsroot/cdx/cdx3.0/src/cdx/cdxpacker.cpp,v $
// $Author: hebertjo $
//
// $Log: cdxpacker.cpp,v $
...
//////////////////////////////////////////////////////////////////////////////////
#ifdef SAVE_RCSID
    static char rcsid = "@(#) $Id: cdxpacker.cpp,v 1.1.1.1 2000/04/22 16:10:54 hebertjo Exp $";
#endif
...
int CDXPacker::SpecWrite(BYTE ch)
{
    ...
    case 2:
        m_lpEProc(ch, pos, width, height, m_data);
        ret = 0;
        break;
    }
...
int CDXPacker::SpecRead(void)
{
    ...
    if (pos < textsize) {
        ...
        case 2:
            ret = (DWORD)m_lpPProc(pos, width, height, m_data);
            break;
        }
    }
